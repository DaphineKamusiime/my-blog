        ...
        <>
            ...
            <section className="px-4 py-32 flex justify-center h-screen align-center bg-black">
                <div className="w-full mx-auto lg:w-1/3">
                    ...
                    <span className="sr-only text-white">Home Page</span>
                    </Link>
                    ...
                    The page you're looking for may have moved or no longer exists. Head back to our <span className="underline text-indigo-500 cursor-pointer">homepage</span>
                    </span>
                    </Link>
                </div>
            </section>
