  ...
  return (
    <div>
      ...
      <div className="relative flex flex-col-reverse py-8 lg:pt-12 lg:flex-col lg:pb-0 h-screen">
        <div className="inset-y-0 top-0 right-9 z-0 w-full max-w-xl px-4 mx-auto md:px-0 lg:pr-0 lg:mb-0 lg:mx-0 lg:w-5/12 lg:max-w-full lg:absolute xl:px-0">
          {/* <svg
          ...
          <Image
            className="w-screen rounded shadow-lg h-object-cover lg:rounded-none lg:shadow-none md:h-90 lg:h-screen"
            src="https://akm-img-a-in.tosshub.com/businesstoday/images/story/202010/jobs_660_130920052343_291020052310.jpg?size=948:533&amp;ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8b2ZmaWNlfGVufDB8fDB8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=700&amp;q=80"
            alt=""
          />
        </div>
        <div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
          <div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
            <q className="inline-block py-px mb-4 text-md font-semibold tracking-wider text-indigo-500 capitalize rounded-full bg-teal-accent-400">
                Job openings in top companies looking for skilled nad talented minds like yourself
            </q>
